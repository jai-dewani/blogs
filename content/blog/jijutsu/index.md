...
Jujutsu is Google’s take on version control, but honestly, I just think of it as 'Git with an Undo button.' I’ve been messing with it on a side project for a week, and it’s already changed how I think about my workflow
...
Martin von Zweigbergk originally started Jujutsu (jj) as a hobby project in late 2019 to experiment with a different user experience in version control.
...
1. **Your working directory IS a commit** - This takes a bit of getting used to but I don't it's bad, this might eventually help users since you only need to compate two commits any instance of time, so less commands to remember maybe. 
...
4. **Everything is undoable.** - Off the top of your head, what are the differences betwen various modes of reset in Git? Feels daunting, ain't it? 
